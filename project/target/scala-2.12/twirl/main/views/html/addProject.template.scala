...
"""),_display_(/*5.2*/main("Add/Change project", user)/*5.34*/ {_display_(Seq[Any](format.raw/*5.36*/("""
    """),_display_(/*6.6*/form(action = routes.ProjectController.form)/*6.50*/ {_display_(Seq[Any](format.raw/*6.52*/("""
        ...
        """),_display_(/*26.10*/inputDate(projectForm("start"), '_label -> "Start Time")),format.raw/*26.66*/("""
        """),_display_(/*27.10*/inputDate(projectForm("end"), '_label -> "End Time")),format.raw/*27.62*/("""
        """),format.raw/*28.9*/("""<input type="submit" value="Add/Update Project">
    """)))}),format.raw/*29.6*/("""
""")))}))
      }
    }
